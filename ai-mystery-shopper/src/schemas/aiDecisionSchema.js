...
const AIDecisionSchema = z.object({
  ...
  action: z.enum(['click', 'type', 'scroll', 'submit', 'finish', 'select', 'switch_window', 'close_window', 'accept_dialog', 'dismiss_dialog', 'prompt_dialog']),
  ...
  const allowsMissingOrSentinel = ['scroll', 'finish', 'switch_window', 'close_window', 'accept_dialog', 'dismiss_dialog', 'prompt_dialog'].includes(decision.action);
