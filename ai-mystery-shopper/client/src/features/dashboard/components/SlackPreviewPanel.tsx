  ...
  return (
    <SurfaceCard>
      ...
      <div className="rounded-xl border border-slate-200 bg-slate-50 p-3">
        <p className="text-sm font-semibold text-slate-900">Friction Alert: {diagnosis || "Healthy"}</p>
        <p className="mt-1 text-sm text-slate-600">Mission: {missionTitle || "Autonomous mission"}</p>
        <p className="mt-1 text-sm text-slate-600">Confusion Score: {frictionScore}/100</p>
